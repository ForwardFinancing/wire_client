...
module WireClient
  ...
  # Lets say the consumer wants to integrate with Citibank. They would invoke AchClient::Citibank,
  # which would be undefined. This const_missing would be called, and the Citibank module would be
  # dynamically defined, with all the necessary SFTP concerns included and ready for use.
  def self.const_missing(name)
    const_set(
      ...
      Class.new do
        ...
        const_set(:WireBatch, Class.new(Sftp::WireBatch))
      end
    )
  end
end
